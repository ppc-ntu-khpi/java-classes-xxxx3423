...
Завдання виконала "**на п'ять**". Виконав перелічені завдання, змінив файл ````README.md```` з скріншотом програми та зберіг та змінив код класу наступним чином:
...
- зробив та зберев у теку ````Solution```` файл ````advanced1.png````, ````advanced1(2 part)png````, ````advanced2.png```` скріншоти результатів роботи програми, та модифікувала файл ````README.md```` відповідним чином.
